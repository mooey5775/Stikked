		...
		<form action="<?php echo base_url(); ?>" method="post" class="form-vertical well">
			<div class="row">
				...
				<div class="span3">
					...
					<?php $set = array('name' => 'lang', 'id' => 'lang', 'class' => 'span3', 'value' => $lang_set, 'maxlength' => '32', 'tabindex' => '1', 'type' => 'hidden');
					echo form_input($set);?>
					<!-- <?php $lang_extra = 'id="lang" class="select span3" tabindex="3" type="hidden"'; echo form_dropdown('lang', $languages, $lang_set, $lang_extra); ?> -->
				</div>
			</div>
			<div class="row">
				<div class="span12">
				...
				<div class="span8">
					...
					<?php endif; ?>
							...
							?>
								<?php if (!$this->config->item('private_only'))
								{
									echo lang('paste_private') . ' - ' . lang('paste_private_desc');
								}?>
					<?php if(!$this->config->item('disable_shorturl')) : ?>
							</label>
						</div>
					...
					<div class="item">
						...
						<?php $set = array('name' => 'expire', 'id' => 'expire', 'class' => 'span3', 'value' => $expire_set, 'maxlength' => '32', 'tabindex' => '1', 'type' => 'hidden');
						echo form_input($set);?>
						<!-- <?php 
